// App.jsx — Afeto em Forma · Sprint 1: Catálogo Dinâmico
...
function AfetoEmFormaApp() {
  ...
  const fetchPedidos = useCallback(async () => {
    ...
    const { data, error } = await supabase.from("pedidos")
      .select("id,status,data_agendada,valor_total,created_at,user_id,fornadas(data),itens_pedido(produto,nome_produto,quantidade,preco_unitario)")
      ...
      {adminOpen && isAdmin && (
        <div className="adm-ov">
          ...
          <div className="adm-body">
            ...
            {/* Tabs */}
            <div className="atabs">
              {[["fornadas","🔥 Fornadas"],["catalogo","📦 Catálogo"],["pedidos","📋 Pedidos"],["grafico","📊 Gráfico"]].map(([k,l]) => (
